...
var ToolBar = (function (_React$Component) {
  ...
  _createClass(ToolBar, [{
    ...
    value: function render() {
      ...
      var searchTextInput = this.props.enableSearch ? _react2['default'].createElement('input', { type: 'text', refs: 'searchInput', placeholder: this.props.searchPlaceholder ? this.props.searchPlaceholder : 'Search', onKeyUp: this.handleKeyUp.bind(this) }) : null;
