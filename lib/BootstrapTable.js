...
var BootstrapTable = (function (_React$Component) {
  ...
  function BootstrapTable(props) {
    ...
    if (!Array.isArray(this.props.data)) {
      ...
      this.props.data.on('change', function (data) {
        _this.store.setData(data, _this.props.multiColumnSearch);
        _this.setState({
  ...
  _createClass(BootstrapTable, [{
    ...
    value: function componentDidUpdate() {
      ...
      if (this.props.options.afterSearchOrFilter) this.props.options.afterSearchOrFilter(this.store.getDataIgnoringPagination());
    }
  }, {
