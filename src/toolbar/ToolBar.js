...
class ToolBar extends React.Component{
  ...
  render(){
    ...
    var searchTextInput = this.props.enableSearch?
      <input type='text' id="search-input" refs='searchInput' placeholder={this.props.searchPlaceholder?this.props.searchPlaceholder:'Search'} onKeyUp={this.handleKeyUp.bind(this)}/>:null;
